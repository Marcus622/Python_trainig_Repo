# STRINGS (str) > Zeichenketten, können Buchstaben, aber auch Zahlen, Leerstellen oder Sonderzeichen beinhalten.
x = "Hallo Welt!!!"
print(x[6:10])
...
# durch. Er printet alles, was nach dem 
...
# 1. BESTIMMTE STELLE BIS ENDE [_:]
# 2. ANFANG BIS BELIEBIGE STELLE [:...]
