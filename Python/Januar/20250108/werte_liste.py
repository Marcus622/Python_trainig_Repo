...
# name_list = ["Christof", "Mete", "Joshua", "Nassima", "Sebastian", "Marcus"]
...
class Vehicles:
    ...
    def get_nr_of_tanks(self):
        distance_with_one_tank = self.consumption * self.volume 

   # (100 L / 10 L / 100 Km = 10) * 100 L
...
print(f"Der gesamte Verbrauch liegt bei: {my_vehicle.get_total_consumption()}")
print(
    f"Das Auto kommt mit {my_vehicle.get_nr_of_tanks()} Tankfüllungen aus, bei einer Strecke von {my_vehicle.km_driven} Km.")
